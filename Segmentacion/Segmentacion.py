...
df_telco = spark.read.csv('/FileStore/tables/churn_Operacion_2.csv', header=True, inferSchema=True)
...
df_telco = spark.read.csv('/FileStore/tables/churn_Operacion_2.csv', header=True, schema=Mischema)
